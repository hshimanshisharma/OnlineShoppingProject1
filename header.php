...
<div class="agileits_header" id="home">
    ...
    <div class="w3l_search">
        <form action="#" method="GET" class="d-flex">
            <input type="search" id="search" placeholder="Search.." name="search" required="required" autofocus="">
...
<!--        <input type="button" name="submit" value="View your cart" class="button" />-->
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light p-lg-0">
                    <h1> <a class="navbar-brand" href="index.php">
                            <span class="capw3" >Z</span>AYO <span class="subcap"></span>
                        </a></h1>
                    <ul class="navbar-nav mx-lg-auto mt-lg-0 mt-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="productpage.php">Best Deals</a>
                        </li>
                    ...
                    <ul class="navbar-nav search-right mt-lg-0 mt-2 w3ls_logo_products_left1 mr-lg-3">
                        <ul class="phone_email">
                            ...
                            <li><a href="mailto:store@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"></i> store@gmail.com</a></li>
                        </ul>
                    </ul>
