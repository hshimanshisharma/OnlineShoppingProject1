           ...
           <div class="col-lg-3 col-sm-6 w3_footer_grid">
            ...
            <div class="col-lg-3 col-sm-6 w3_footer_grid">
                ...
                <ul class="w3_footer_grid_list">
                    <li><a href="events.php"><i class="fa fa-angle-right mr-2" aria-hidden="true"></i> Events</a>
                    </li>
                    <li><a href="about.php"><i class="fa fa-angle-right mr-2" aria-hidden="true"></i> About Us</a>
                    </li>
                    <li><a href="index.php"><i class="fa fa-angle-right mr-2" aria-hidden="true"></i> Best
                            Deals</a></li>
                    <li><a href="services.php"><i class="fa fa-angle-right mr-2" aria-hidden="true"></i>
                            Services</a></li>
            ...
            <div class="col-lg-3 col-sm-6 w3_footer_grid">
                ...
                <ul class="w3_footer_grid_list">
                    ...
                    <li><a href="privacy.php"><i class="fa fa-angle-right mr-2" aria-hidden="true"></i> privacy
                            policy</a></li>
                    <li><a href="privacy.php"><i class="fa fa-angle-right mr-2" aria-hidden="true"></i> terms of
                            use</a></li>
                </ul>
            </div>
...
<!--            </div>-->
        ...
        <div class="wthree_footer_copy">
            <p>© 2022 Corner Store. All rights reserved | Design by <a href="http://vmmeducation.com/">Himanshi Sharma</a>
            </p>
        </div>
    </div>
</div>
