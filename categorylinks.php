    ...
    <nav class="navbar navbar-expand-lg navbar-light p-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav nav_1">
                <li class="nav-item"><a class="nav-link" href="productpage.php">All Categories</a></li>
                <?php
                ...
                while($row1 = mysqli_fetch_array($res1)){
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu w3ls_vegetables_menu" aria-labelledby="navbarDropdown">
                            <?php
                            $sel="select * from subcategorytable where categoryid=$row1[0]";
                            $res2=mysqli_query($conn,$sel);
                            while($row2=mysqli_fetch_array($res2)){
                            ?>
                            <a class="dropdown-item" href="productpage.php?subcatid=<?php echo $row2['subcatid']; ?>" class="drop-text">
                                <?php
