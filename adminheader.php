        ...
        <section class="w3l-header-4 sec-part-4">
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light p-lg-0">
                    <h1> <a class="navbar-brand" href="adminhomepage.php">
                            <span class="capw3">Z</span>AYO <span class="subcap"></span>
                        </a></h1>
                    <ul class="navbar-nav mx-lg-auto mt-lg-0 mt-3">
                        <li class="nav-item active">
                            <a class="nav-link" href="newcategory.php">Category</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="viewsubcategory.php">Sub-Category</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="navbar-nav search-right mt-lg-0 mt-2 w3ls_logo_products_left1 mr-lg-3">
                        <ul class="phone_email">
                            ...
                            <li><a href="mailto:himanshisharma0512@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"></i>himanshisharma0512@gmail.com</a></li>
                        </ul>
                    </ul>
