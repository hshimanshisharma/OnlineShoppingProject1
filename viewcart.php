            ...
            if(isset($_SESSION['products'])){
                ...
                for($i=0;$i<count($_SESSION['products']);$i++){
                    ...
                    <tr>
                        ...
                        <td><button class="fa fa-trash text-danger" onclick="deleteitem(<?php echo $ar[$i]->productid;?>)"></button></td>
                    </tr>
                    <?php
                }
                ?>
                <tr>
                    ...
                    <th>Rs.<?php echo $grd_ttl; ?></th>
                </tr>

                <tr>
                    <td colspan="6" style="text-align: center;">
                        <a href="index.php" class="btn btn-warning">Continue Shopping</a>
                        <a href="proceedtopay.php" class="btn btn-success">Proceed To Pay</a>
                    </td>
                </tr>
                <?php
                     }
...
<!--                        <h3>CART IS EMPTY</h3>-->
                        <img src="images2/img_18.png" width="300">
                    </th>
                </tr>
                <?php
            }
